                    ...
                    <div class="section">
                        <div class="accordion-item">
                            ...
                            <div id="feedback_sonoro" class="accordion-content">
                                <button onclick="toggleButtonContent('suono_conferma', this)">Suono di conferma
                                    <img src="img/freccia_alto.svg" alt="freccia2" class= "button-arrow">
                                </button>
                               
                                <div id="suono_conferma" class="button-content">
                                    
                                    <div class="button-group">
                                        <div class="button-container2">
                                            <button onclick="updateMobilePreview('img/Nota_musicale.svg')">
                                    ...
                                    <div class="button-container-btn-other" style=" justify-content: center; margin-left: 40px;">
                                ...
                                <button onclick="toggleButtonContent('suono_errore', this)">Suono di errore
                                    <img src="img/freccia_alto.svg" alt="freccia2" class= "button-arrow">
                                </button>
                                
                                <div id="suono_errore" class="button-content">
                                    <div class="button-group">
                                        <div class="button-container2">
                                            <button onclick="updateMobilePreview('img/Nota_musicale.svg')">
                                                <img src="img/Nota_musicale.svg" alt="icon">
                                ...
                                <button onclick="toggleButtonContent('suono_notifica', this)">Suono di notifica
                                    <img src="img/freccia_alto.svg" alt="freccia2" class= "button-arrow">
                                </button>
                                <div id="suono_notifica" class="button-content">
                                ...
                                <button onclick="toggleButtonContent('suono_avviso', this)">Suono di avviso
                                    <img src="img/freccia_alto.svg" alt="freccia2" class= "button-arrow">
                                </button>
                                <div id="suono_avviso" class="button-content">
